...
export const Srvmainten=()=>{
    return (
        <>
        <center><h3 className="hd3">Maintenance</h3></center>
          <Row className="cnt2-row">
            <Col xs={3} className="content21">
         <div >
          <img className="im1" src={b1} alt=''/>
         </div>
          <h3 className="srvhd3">Planned Preventive</h3>
         ...
         <h3 className="srvhd3">Cradle Maintenance</h3>
         <div className="cleaningp1">
         ...
         <h3 className="srvhd3">Cradle Rental (AMC)</h3>
